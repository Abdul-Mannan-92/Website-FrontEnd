...
**RedStore** is a clean, modern, and responsive e-commerce web interface created as part of a Web Development Internship at **Rejolt Edtech Pvt. Ltd.** in collaboration with the **Lords Institute of Engineering and Technology**. The project showcases frontend layout design, custom typography, user experience principles, and interactive product displays.
...
| :--- | :--- |
| **HTML5** | Web page structure, semantic layout tags, and document hierarchy. |
| **CSS3** | Custom layout styling, color palettes, responsive flexbox positioning, and typography. |
| **JavaScript** | Interactivity, event handling, and dynamic component behaviors. |
| **VS Code** | Primary Integrated Development Environment (IDE). |
| **Git & GitHub** | Code tracking and version control repository hosting. |
...
* **Week 3:** Project Execution (Building RedStore layout and UI features).
* **Week 4:** Project Validation, UI polish, color theory refinement, and bug fixing.
...
├── images/                 # Product images, brand logos, and banners
